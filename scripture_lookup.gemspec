...
Gem::Specification.new do |s|
  ...
  s.files         = ["lib/scripture_lookup.rb", "lib/scripture_lookup/crossways_esv_provider.rb", "lib/scripture_lookup/bible_gateway_scraper.rb", "lib/scripture_lookup/response.rb", "lib/scripture_lookup/parsers/bible_gateway_scrape_parser.rb"]
  s.require_paths = ["lib"]
